...
const METEO_URL = process.env.EXPO_PUBLIC_OPEN_METEO_API || 'https://api.open-meteo.com/v1/forecast';
const EONET_URL = process.env.EXPO_PUBLIC_NASA_EONET_API || 'https://eonet.gsfc.nasa.gov/api/v3/events';
